...
public class Kamar {
    ...
    private TipeKamarEnum tipeKamar;
    ...
    public TipeKamarEnum getTipeKamar() {
        return tipeKamar;
    }

    public void setTipeKamar(TipeKamarEnum tipeKamar) {
    ...
    public void prePersist() {
        ...
        this.dibuatPada = now;
        this.diperbaruiPada = now;
    }

    @PreUpdate
    public void preUpdate() {
        this.diperbaruiPada = LocalDateTime.now();
    }

    public enum TipeKamarEnum { // Enum
        SINGLE, DOUBLE, SUITE;

        public static TipeKamarEnum fromString(String type) {
            try {
                return TipeKamarEnum.valueOf(type.toUpperCase());
            } catch (IllegalArgumentException e) {
                throw new RuntimeException("Invalid RoomType: " + type);
            }
        }
    }
